...
Figure~\ref{fig:transformer} illustrates the overall architecture of the Transformer model, including its encoder and decoder stacks.
...
improved instruction following \cite{brown2020gpt3}, as shown in Figure~\ref{fig:openai-logo}.
...
\cite{touvron2023llama}, as shown in Figure~\ref{fig:llama-logo}.
...
that span multiple languages and writing systems \cite{qwen2025qwen25}, as shown in Figure~\ref{fig:qwen-logo}.
...
scenarios with limited hardware resources \cite{gemma2024google}, as shown in Figure~\ref{fig:gemma-logo}.
...
is often indistinguishable from full fine-tuning \cite{hu2021lora}. Figure~\ref{fig:lora} illustrates how LoRA injects trainable low-rank matrices alongside the frozen pre-trained weights.

\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{figures/lora_diagram.jpg}
...
resources \cite{dettmers2023qlora}. Figure~\ref{fig:lora-vs-full} compares the parameter update strategies of LoRA and full fine-tuning.

\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{figures/lora_vs_fft.png}
...
\cite{lewis2020rag}. Figure~\ref{fig:rag-pipeline} illustrates the three stages of the RAG pipeline.

\clearpage
\begin{sidewaysfigure}
\centering
\includegraphics[width=0.95\textheight]{figures/rag_pipeline.jpg}
...
integration overhead low \cite{chroma2024docs}, as shown in Figure~\ref{fig:chroma-logo}.
...
metadata filtering \cite{qdrant2024docs}, as shown in Figure~\ref{fig:qdrant-logo}.
...
approaches. Figure~\ref{fig:chunking-methods} summarizes the main chunking strategies applicable to RAG pipelines.

\clearpage
\begin{sidewaysfigure}
\centering
\includegraphics[width=0.95\textheight]{figures/chunking_methodes.png}
...
Tunisie \cite{ollama2024docs}, as shown in Figure~\ref{fig:ollama-logo}.
...
\cite{kwon2023vllm}, as shown in Figure~\ref{fig:vllm-logo}.
...
model execution \cite{ollama2024docs}, as shown in Figure~\ref{fig:llamacpp-logo}.
