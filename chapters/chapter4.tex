...
\begin{quote}
En vertu de l'article premier de l'arrêté relatif au concours de recrutement de gestionnaires de documents et d'archives, les candidats doivent être titulaires soit d'un diplôme de technicien supérieur en gestion des archives et de la documentation (deux années d'études supérieures), soit d'un mastère en sciences de l'information et des bibliothèques (quatre années d'études supérieures). La limite d'âge est fixée à quarante ans à la date de clôture des candidatures.
Sources~: art.~1 de l'arrêté, JORT n\textsuperscript{o}~2, 6 janvier 2026. Ceci ne constitue pas un avis juridique.
\end{quote}
...
Both models correctly identified the two diploma pathways and the age limit stated in Article~1, and cited the source in the expected format. The reranker score for this article exceeded the 0.4 confidence threshold, confirming that generation was triggered on a reliable retrieval result.
...
\begin{quote}
\textarabic{وفقاً للفصل الأول من القرار المتعلق بمناظرة انتداب متصرفي الوثائق والأرشيف بالمجلس الوطني للجهات والأقاليم، يُشترط في المترشح أن يكون حاملاً إما لشهادة تقني سامٍ في الأرشيف والتوثيق، أو لشهادة الماجستير في علوم المعلومات والمكتبات، على ألا يتجاوز سنُّه أربعين سنة عند غلق التسجيل. المصادر: الفصل الأول، الرائد الرسمي عدد~2، 6 جانفي 2026. هذا لا يُعدّ استشارةً قانونية.}
\end{quote}
...
\begin{quote}
Je n'ai pas trouvé d'articles juridiques pertinents dans la base de connaissances concernant les sanctions en matière de fraude fiscale en Tunisie. Ce sujet n'est pas couvert par les documents actuellement indexés. Pour obtenir des informations précises, je vous recommande de consulter un avocat spécialisé en droit fiscal tunisien ou de vous référer directement au Code des droits et procédures fiscaux. Ceci ne constitue pas un avis juridique.
\end{quote}
...
The confidence gate fired at step~5: the highest reranker score across the 20 Qdrant candidates fell below 0.4, meaning none of the retrieved articles met the relevance threshold. Rather than returning an automatic fallback message, the pipeline notified each model that no relevant articles were found. Both models generated a decline response on that basis, without any legal article in their context. The responses differ slightly in phrasing, as each model produces its own natural language output, but both correctly acknowledge the gap and direct the user to an appropriate resource.
